...
class FarmaSDK {
    constructor(config) {
        ...
        const fullKeyBytes = js_base64_1.Base64.toUint8Array(this.config.privateKey);
        ...
        this.publicKey64 = js_base64_1.Base64.fromUint8Array(this.publicKey);
    }
    async request(method, path, body = null) {
        ...
        const signature = ed25519_1.ed25519.sign(message, this.privateKeyBytes);
        const signature64 = js_base64_1.Base64.fromUint8Array(signature);
